...
DELTA_ANGLE = 55            # deg between each side's "side ray" and its "front-diagonal ray"
...
KP, KD = 0.012, 0.0                # gains when following a single wall
KP_CENTER, KD_CENTER = 0.012, 0.0   # gains when centering between two walls
# 0.018
...
def update_slow():
    ...
    print(f"right={right_room:.2f}  left={left_room:.2f} ")
